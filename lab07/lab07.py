...
def is_bst(t):
    ...
    def bst_helper(t, min, max):
        ...
        if len(t.branches) > 2:
            return False
        if len(t.branches) == 1:
            return bst_helper(t.branches[0], min, t.label) or bst_helper(t.branches[0], t.label, max)
        if len(t.branches) == 2:
            return bst_helper(t.branches[0], min, t.label) and bst_helper(t.branches[1], t.label, max)
